...
var books = {
    0: {
        ...
        long: 'Op zomaar een dag uit het leven van Herman Brusselmans heeft hij heel wat te doen. Wakker worden, opstaan, tandenpoetsen. Spek eten. De echtgenote uitwuiven die naar Antwerpen vertrekt. De hond naar een oud, bevriend echtpaar brengen. Naar de apotheker gaan. Navraag doen in een motorwinkel. Een depressieve vrouw onderhouden en haar meenemen naar een restaurant, om er een eenvoudige lunch te gebruiken.',
        review: {
            rating: 5,
